...
def index(params):
    ...
    print('Initialised Firebase App')
    ...
    print('Collected Training From Videos')
    ...
    model.fit_generator(datagen.flow(X , Y , batch_size = 32) , steps_per_epoch = len(X)//32 , epochs = 1, shuffle = True , verbose=1)
    ...
    print('Model Saving In Firebase')
